...
public class SearchFeedViewModel extends BaseViewModel {
    ...
    public void search(String clubName) {
        requestDynamicList(0, clubName);
    }
    ...
    private void requestDynamicList(final int offset, String clubName) {
        BmobQuery<Dynamic> query = new BmobQuery<>();
        query.setSkip(offset)
                .order("-createdAt")
                .include("user")
                .addWhereEqualTo("clubName", clubName);
